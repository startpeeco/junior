        ...
        <div className="header-container">
          ...
          <Link href="/profile">
            <a className="header-link1">
              <div className="header-container1">
                ...
                <span className="header-text TextSM">SOBRE MIM</span>
              </div>
            </a>
          </Link>
          ...
          <a href="https://blog.primojunior.com/" className="header-link3">
            <div className="header-container3">
              ...
              <span className="header-text2 TextSM">NOSSO PROJETO</span>
            </div>
          </a>
        </div>
            ...
            <Link href="/profile">
              <a className="header-link4">
                <div className="header-container4">
                  ...
                  <span className="header-text3 TextSM">SOBRE MIM</span>
                </div>
              </a>
            </Link>
            <Link href="/blog-post">
...
Header.defaultProps = {
  rootClassName: '',
  image_alt: 'image',
  image_src2: '/primo-1500h.png',
  image_alt2: 'image',
  image_alt1: 'image',
  image_src: '/primojunior%20%5B1%5D-200h.png',
  image_src1: '/primo-1500h.png',
}
